...
class Convert {
   ...
   public void convert() {
     ...
     //printing the binary value,octal value and hexa decimal value
      System.out.println("Binary equivalent : "+binary+" Octal equivalent : "+octal+" HexaDecimal equivalent : "+hexa);
